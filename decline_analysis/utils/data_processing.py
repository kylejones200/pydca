...
def detect_production_anomalies(
    ...
    """
    Detect anomalous production values using standard deviation.
    
    Flags values that are more than threshold_std standard deviations
    ...
    anomalies = z_score > threshold_std
