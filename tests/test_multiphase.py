...
class TestMultiPhaseData:
    ...
    def test_calculate_water_cut(self, sample_data):
        ...
        pd.testing.assert_series_equal(ratios['water_cut'], expected_wc, check_names=False)
    ...
    def test_calculate_liquid_rate(self, sample_data):
        ...
        pd.testing.assert_series_equal(ratios['liquid_rate'], expected_liquid, check_names=False)
...
class TestIntegration:
    ...
    def test_full_workflow_with_real_data_structure(self):
        ...
        water = pd.Series(
            oil.values * water_cut / (100 - water_cut),
            index=dates,
            name='water'
        )
