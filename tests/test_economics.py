...
class TestEconomicMetrics:
    ...
    def test_single_period_economics(self):
        ...
        assert result['npv'] == result['cash_flow'][0]  # No discounting for single period
...
class TestEconomicsIntegration:
    ...
    def test_economics_with_pandas_series(self):
        ...
        production = pd.Series([1000, 950, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450], 
                              index=dates)
    ...
    def test_economics_realistic_scenarios(self):
        ...
        gas_production = np.array([5000, 4500, 4000, 3600, 3200, 2900, 2600, 2300, 2100, 1900])
    ...
    def test_economics_price_sensitivity(self):
        ...
        assert break_even_found or prices[0] > opex  # Either found break-even or all prices profitable
...
class TestEconomicsErrorHandling:
    ...
    def test_negative_production_values(self):
        ...
        q = np.array([100, -50, 80])  # Negative production (shouldn't happen in reality)
        
        result = economic_metrics(q, 60.0, 15.0, 0.10)
        
        # Should handle gracefully
        assert len(result['cash_flow']) == 3
        assert result['cash_flow'][1] < 0  # Negative production gives negative cash flow
