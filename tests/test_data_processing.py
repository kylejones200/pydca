...
class TestCalculateDaysOnline:
    ...
    def test_with_different_online_dates(self):
        ...
        df = pd.DataFrame({
            'date': dates,
            'online_date': [pd.Timestamp('2020-01-01')] * 5
        })
...
class TestNormalizeToDailyRate:
    ...
    def test_basic_normalization(self):
        ...
        df = pd.DataFrame({
            'Oil': [3000, 2800, 3100],  # Monthly totals
            'Days': [30, 28, 31]
        })
...
class TestFilterWellsByDateRange:
    ...
    def test_basic_filtering(self):
        ...
        filtered = dp.filter_wells_by_date_range(
            df, 'date', '2020-03-01', '2020-06-01'
        )
