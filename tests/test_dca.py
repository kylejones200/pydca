...
class TestDCAAPI:
    ...
    def test_forecast_function(self, sample_production_data):
        ...
        result = dca.forecast(sample_production_data, model="arps", kind="hyperbolic", horizon=12)
    ...
    def test_forecast_different_models(self, sample_production_data):
        ...
        for model in models:
            if model == "arps":
                result = dca.forecast(sample_production_data, model=model, kind="exponential")
            else:
    ...
    def test_evaluate_function(self, sample_production_data):
        ...
        np.random.seed(42)
        y_pred = sample_production_data + np.random.normal(0, sample_production_data * 0.05)
    ...
    def test_evaluate_non_overlapping_indices(self, sample_production_data):
        ...
        future_dates = pd.date_range(start='2025-01-01', periods=len(sample_production_data), freq='MS')
